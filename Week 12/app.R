...
library(rsconnect)
rsconnect::setAccountInfo(name='noahgallego', token='22C4C49F2FB79E20EDA8C9A66F3B475C', secret='GjdkTT/dM034b2Gnzq2qg3NlHYBWcIh+u0buAJV7')
library(shiny)
...
rsconnect::deployApp('/Users/noahgallego/Desktop/R Projects/Week 12')
